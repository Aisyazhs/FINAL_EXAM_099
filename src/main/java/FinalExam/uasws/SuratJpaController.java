...
import FinalExam.uasws.exceptions.NonexistentEntityException;
import FinalExam.uasws.exceptions.PreexistingEntityException;
...
public class SuratJpaController implements Serializable {
    ...
    private EntityManagerFactory emf = Persistence.createEntityManagerFactory("FinalExam_uasws_jar_0.0.1-SNAPSHOTPU");
    ...
    public void create(Surat surat) throws PreexistingEntityException, Exception {
        ...
        try {
            ...
            if (findSurat(surat.getNoSurat()) != null) {
